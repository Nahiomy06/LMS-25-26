...
const btnCambiarTema = document.getElementById("toggle-tema");
...
btnCambiarTema.addEventListener("click", () => {
    ...
    if (body.classList.contains("oscuro")){
        btnCambiarTema.textContent = "Cambiar a modo claro";
    } else {
        btnCambiarTema.textContent = "Cambiar a modo oscuro";
    }
});
...
tarjeta.forEach(tarjeta => {
    const btnAnadir = tarjeta.querySelector('[data-action="add"]');
